...
In data/fetched folder, you can find the raw HUD files. The majority are Excel spreadsheets. Filenames start with the reported last-modified date from the http response headers.

In data/converted folder, you can find the HUD files, now converted to JSONL files. 
...
### Notes on the Data
- The data/fetched folder contains files last modified on dates in 2011 - 2025. It does not comprise the complete historical record of files uploaded by HUD to the tracked webpages. 
